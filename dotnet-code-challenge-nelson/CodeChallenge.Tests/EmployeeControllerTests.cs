...
namespace CodeCodeChallenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        [TestMethod]
        public void GetReportingStructure1_Returns_Ok()
        {
            // Arrange
            ...
            // Execute
            Task<HttpResponseMessage> getRequestTask = _httpClient.GetAsync($"api/employee/reports/{employeeId}");
        ...
        [TestMethod]
        public void GetReportingStructure2_Returns_Ok()
        {
            // Arrange
        ...
        [TestMethod]
        public void GetReportingStructure3_Returns_Ok()
        {
            // Arrange
